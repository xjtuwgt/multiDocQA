...
def trainer_builder(args):
    ...
    hotpotQA_model = LongformerRandHotPotQAModel(args=args, fix_encoder=fix_encoder).to(device)
    # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    return hotpotQA_model, train_data_loader, dev_data_loader, optimizer[0], scheduler[0]
