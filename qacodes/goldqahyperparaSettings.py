import argparse
import torch
from modelUtils.longformerUtils import PRE_TAINED_LONFORMER_BASE, PRE_TAINED_LONFORMER_LARGE
...
def parse_args(args=None):
    ...
    parser.add_argument('--valid_data_name', type=str, default='hotpot_dev_distractor_wiki_tokenized.json')
    ...
    parser.add_argument('--pretrained_cfg_name', default=PRE_TAINED_LONFORMER_LARGE, type=str)
    parser.add_argument('--hop_model_name', default='DotProduct', type=str)  # 'DotProduct', 'BiLinear'
    parser.add_argument('--frozen_layer_num', default=12, type=int, help='number of layers for document encoder frozen during training')
    ...
    parser.add_argument('-cpu', '--cpu_num', default=32, type=int) ### for data_loader
    parser.add_argument('-init', '--init_checkpoint', default=None, type=str)
    parser.add_argument('-save', '--checkpoint_path', type=str, default='../gold_checkpoints')
    parser.add_argument('-log', '--log_path', type=str, default='../gold_hotpot_logs')
    parser.add_argument('--log_name', default='goldqalog', type=str)
    ##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
