...
def parse_args(args=None):
    ...
    parser.add_argument('--train_data_name', type=str, default='hotpot_train_distractor_wiki_encoded.json') ##encoded/combined
    ...
    parser.add_argument('--valid_data_name', type=str, default='hotpot_dev_distractor_wiki_encoded.json')  ##encoded/combined
    parser.add_argument('--test_data_name', type=str, default='hotpot_test_distractor_wiki_encoded.json')  ##encoded/combined
    ##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    parser.add_argument('--frozen_layer_num', default=4, type=int, help='number of layers for document encoder frozen during training')
