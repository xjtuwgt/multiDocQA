...
def parse_args(args=None):
    parser = argparse.ArgumentParser(
        description='Training and Testing Long Sequence Reason Model (IR)')
    ...
    parser.add_argument('--frozen_layer_num', default=10, type=int, help='number of layers for document encoder frozen during training')
    ...
    parser.add_argument('--layer_number', default=2, type=int)
    ...
    parser.add_argument('-save', '--checkpoint_path', default='../ir_checkpoints', type=str)
    ...
    parser.add_argument('-lr', '--learning_rate', default=6e-5, type=float) # 1e-5 level
